                ...
                <div class="col-md-9">
                    <div class="card card-primary" id="feature-card">
                        <form action="<?=base_url('front/save-feature')?>" method="POST" id="feature-form">
                            <input type="hidden" name="update_id" value="<?=htmlspecialchars($this->uri->segment(3))?>">
