    ...
    <div class="card-body row">
      <div class="form-group col-md-12">
        <div class="form-check form-check-inline">
          ...
          <label class="d-block form-check-label" for="offline_bank_transfer"><?=$this->lang->line('active')?$this->lang->line('active'):'Active'?> 
            <i class="fas fa-question-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?=$this->lang->line('you_have_to_contact_a_user_by_yourself_for_further_process')?$this->lang->line('you_have_to_contact_a_user_by_yourself_for_further_process'):'You have to contact a user by yourself for further process.'?>"></i>
          </label>
        </div>
      </div>
    </div>
