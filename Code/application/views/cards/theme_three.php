					...
					<div class="card card-profile shadow mb-0">
						...
						<div class="card-body">
                            ...
                            <ul class="contact-details">
                                ...
                                <li>
                                    <a href="<?=(isset($social_options['mandatory']['address_url']) && $social_options['mandatory']['address_url'] != '')?$social_options['mandatory']['address_url']:'#'?>" <?=(isset($social_options['mandatory']['address_url']) && $social_options['mandatory']['address_url'] != '')?'target="_blank"':''?> class="media contact-details-item">
