...
<link rel="stylesheet" href="<?=base_url('assets/css/cards/theme-two.css')?>">
</head>
<body>
<div class="container">
    <div class="row pt-1">
        <div class="col-xl-5 col-md-6 col-sm-10 mx-auto shadow rounded p-0">
            ...
            <div class="bg-white shadow rounded overflow-hidden">
                ...
                <div class="px-4 pt-0 pb-4 bg-dark bg-image" <?=(isset($banner) && $banner != '')?'style="background-image:url('.htmlspecialchars($banner).')"':''?> >
                    <div class="media align-items-end profile-header">
                        <div class="profile mr-3">
                            <img src="<?=isset($meta_image)?htmlspecialchars($meta_image):''?>" alt="<?=isset($card['title'])?htmlspecialchars($card['title']):''?>" width="130" class="rounded mb-4 img-thumbnail">
                        </div>
                        <div class="media-body mb-5 text-white">
                            <h4 class="mt-0 mb-0"><?=isset($card['title'])?htmlspecialchars($card['title']):''?></h4>
                            <p class="mb-3"><?=isset($card['sub_title'])?htmlspecialchars($card['sub_title']):''?></p>
                        </div>
                    </div>
                </div>

                <h6 class="bg-light p-4 pt-5 font-weight-normal justify-content-end">
                ...
                <div class="py-4 px-4">
                    <ul class="contact-details">
                        ...
                        <li>
                            ...
                            <span class="mr-3 icon-circle rounded"><i class="fa fa-phone m-0"></i></span>
                            <h6 class="mt-0 mb-0"><?=htmlspecialchars($social_options['mandatory']['mobile'])?></h6></a>
                        </li>
                        <?php } ?>
                        ...
                        <?php if(isset($social_options['mandatory']) && isset($social_options['mandatory']['email']) && $social_options['mandatory']['email'] != ''){ ?>
                            <li>
                                ...
                                <span class="mr-3 icon-circle rounded"><i class="fa fa-envelope m-0"></i></span>
                                <h6 class="mt-0 mb-0"><?=htmlspecialchars($social_options['mandatory']['email'])?></h6></a>
                            </li>
                        <?php } ?>
                        ...
                        <li>
                            ...
                            <span class="mr-3 icon-circle rounded"><i class="fab fa-whatsapp m-0"></i></span>
                            <h6 class="mt-0 mb-0"><?=$this->lang->line('whatsapp')?htmlspecialchars($this->lang->line('whatsapp')):'WhatsApp'?></h6></a>
                        </li>
                        <?php } ?>
                        ...
                        <li>
                            ...
                            <span class="mr-3 icon-circle rounded"><i class="fa fa-globe m-0"></i></span>
                            <h6 class="mt-0 mb-0"><?=htmlspecialchars($social_options['mandatory']['website'])?></h6></a>
                        </li>
                        <?php } ?>
                        ...
                        <li>
                            ...
                            <span class="mr-3 icon-circle rounded"><i class="fa fa-map-marker m-0"></i></span>
                            <h6 class="mt-0 mb-0"><?=htmlspecialchars($social_options['mandatory']['address'])?></h6></a>
                        </li>
                        <?php } ?>
                            ...
                            <?php
                                ...
                                <?php
                                    ...
                                    <li>
                                        ...
                                        <span class="mr-3 icon-circle rounded"><i class="m-0 <?=(isset($icon) && $icon != '')?htmlspecialchars($icon):'fa fa-hand-holding-heart'?>"></i></span>
                                        <h6 class="mt-0 mb-0"><?=(isset($text) && $text != '')?htmlspecialchars($text):((isset($url) && $url != '')?htmlspecialchars($url):'')?></h6></a>
                                    </li>
                                <?php } } } ?>
                            <?php } } ?>
                        <?php } } ?>
